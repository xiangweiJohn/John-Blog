...
import com.john.blog.website.model.Vo.MetaVo;
import com.john.blog.website.service.IAudioService;
import com.john.blog.website.service.ICommentService;
import com.john.blog.website.service.IContentService;
import com.john.blog.website.service.IMetaService;
import com.john.blog.website.service.ISiteService;
import com.john.blog.website.utils.GsonUtils;
import com.john.blog.website.utils.IPKit;
import com.john.blog.website.utils.PatternKit;
import com.john.blog.website.utils.TaleUtils;
import com.vdurmont.emoji.EmojiParser;

/**
 * 首页 Created by john on 2018/4/17.
 */
@Controller
public class IndexController extends BaseController {
	...
	@ResponseBody
	public List<AudiosVo> audios(HttpServletRequest request) {
		// 获取全部aaudio的URL
		List<AudiosVo> audios = iAudioService.getAudios();
		return audios;
	}
